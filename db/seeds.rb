...
reservation = Reservation.create!(check_in: '2022-05-26', check_out: '2022-05-31', room_id: room2.id, user_id: '2')

reservation = Reservation.create!(check_in: '2022-05-26', check_out: '2022-05-31', room_id: room3.id, user_id: '2')